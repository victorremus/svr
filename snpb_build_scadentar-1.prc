...
-- teo @ 18-12-2006
    ...
    if v_flag_corona in ('MORAT','MORBA') /*and r_credit.suma_dobanda_db :=*/ then --AND de adaugat conditie modificare prima dobanda doar cand suntem in perioada de gratie
