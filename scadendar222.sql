...
-- / teo @ 18-12-2006
 ...
 insert into cre_scadentar_tmp(
                ...
                cp_credit.credit_id, a_data(i), a_rata(i), a_dobanda(i),6666666 /*a_sold(i)*/, a_rata_platita(i), a_is_rata(i), a_is_dobanda(i), a_dobanda_precalculata(i), a_comisioane(i), rtrim(a_comisioane_desc(i), g_enter)
            );
